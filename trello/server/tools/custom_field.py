...
async def get_board_custom_fields(ctx: Context, board_id: str | None = None) -> str:
    ...
    fields = await service.get_board_custom_fields(board_id)
...
async def create_custom_field(ctx: Context, name: str, field_type: str, pos: str = "bottom", board_id: str | None = None) -> str:
    ...
    field = await service.create_custom_field(payload)
...
async def update_custom_field(ctx: Context, field_id: str, name: str = None, pos: str = None) -> str:
    ...
    field = await service.update_custom_field(field_id, name=name, pos=pos)
...
async def get_card_custom_field_values(ctx: Context, card_id: str) -> str:
    ...
    items = await service.get_card_custom_field_items(card_id)
...
async def set_custom_field_value_checkbox(ctx: Context, card_id: str, field_id: str, checked: bool) -> str:
    ...
    await service.set_custom_field_value(card_id, field_id, payload)
...
async def add_custom_field_option(ctx: Context, field_id: str, text: str, color: str = "none", pos: str = "bottom") -> str:
    ...
    option = await service.add_custom_field_option(field_id, text, color, pos)
...
async def update_custom_field_option(ctx: Context, option_id: str, text: str = None, color: str = None, pos: str = None) -> str:
    ...
    await service.update_custom_field_option(option_id, text, color, pos)
    return f"Updated option {option_id}"


async def delete_custom_field_option(ctx: Context, option_id: str) -> str:
    """Delete a custom field option."""
    await service.delete_custom_field_option(option_id)
